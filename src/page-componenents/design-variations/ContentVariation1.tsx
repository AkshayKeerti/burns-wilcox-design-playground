...
export default function ContentVariation1() {
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <div className="bg-corporate-blue-900 text-white">
        <div className="container mx-auto px-4 py-20">
          <div className="max-w-4xl mx-auto">
            <div className="inline-flex items-center px-4 py-2 bg-white text-corporate-blue-900 rounded-full text-sm font-light mb-6">
              <span className="w-2 h-2 bg-corporate-blue-500 rounded-full mr-2"></span>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <button className="border-2 border-white text-white px-8 py-3 rounded-lg font-light hover:bg-white hover:text-corporate-blue-900 transition-colors">
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-1">
            {/* Contact Card */}
            <div className="bg-corporate-blue-900 text-white p-6 rounded-lg mb-8 border-2 border-corporate-blue-900">
              ...
              <button className="w-full bg-white text-corporate-blue-900 py-3 px-4 rounded-lg font-light hover:bg-corporate-grey-50 transition-colors mb-4 border-2 border-corporate-blue-900">
                Request Cyber Quote
              </button>
            ...
            <div className="bg-corporate-grey-900 text-white p-6 rounded-lg mb-8">
              <div className="flex items-center mb-4">
                {[...Array(5)].map((_, i) => (
                  <Star key={i} className="w-4 h-4 fill-corporate-blue-400" />
                ))}
              </div>
              ...
              <div className="flex items-center">
                <div className="w-10 h-10 bg-corporate-blue-900 rounded-full flex items-center justify-center mr-3">
                  <span className="font-light text-white">MS</span>
                </div>
                <div>
