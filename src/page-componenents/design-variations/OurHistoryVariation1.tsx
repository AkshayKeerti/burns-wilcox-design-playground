    ...
    <section className="bg-white w-full">
      ...
      <div className="relative h-[80vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <Image src="/hero-1.jpg" alt="Our History" fill className="object-cover" priority />
        ...
        <div className="relative z-10 text-center text-white max-w-5xl mx-auto px-8">
          <div className="mb-12">
            ...
            <p className="text-xl md:text-2xl font-light text-white/90 max-w-3xl mx-auto leading-relaxed mb-8">
              Five decades of excellence in insurance, building trust and delivering innovative
            ...
            {historyEras.map((era) => (
              ...
              >
                <div className="relative h-48">
                  <Image src={era.image} alt={era.title} fill className="object-cover" />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent"></div>
                  <div className="absolute bottom-4 left-4">
                    <span
                      className={`inline-block bg-gradient-to-r ${era.color} text-white px-4 py-2 rounded-full text-lg font-bold`}
                    >
                      {era.decade}
                    </span>
                  </div>
                ...
                <div className="p-8">
                  <h3 className="text-2xl font-bold text-corporate-grey-900 mb-3">{era.title}</h3>
                  <p className="text-corporate-grey-600 mb-4 leading-relaxed">{era.description}</p>
      ...
      <div className="py-20 px-8 bg-gradient-to-r from-corporate-blue-600 to-corporate-blue-700">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-white/90 mb-8 leading-relaxed">
            Join us in building the future of insurance with innovative solutions and trusted
            partnerships
          </p>
