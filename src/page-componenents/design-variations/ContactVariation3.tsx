      ...
      <div ref={heroRef} className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white max-w-5xl mx-auto px-8">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 max-w-2xl mx-auto">
            <h3 className="text-2xl font-bold mb-2">{contactMethods.find(m => m.id === selectedMethod)?.title}</h3>
            <p className="text-white/90 mb-3">{contactMethods.find(m => m.id === selectedMethod)?.subtitle}</p>
            ...
            {contactMethods.map((method) => (
              ...
              >
                <div className="text-center">
                  <div className={`text-5xl mb-4 bg-gradient-to-r ${method.color} bg-clip-text text-transparent`}>
                    {method.icon}
                  </div>
                  ...
                  >
                    <div className="flex items-start justify-between">
                      <div>
                        ...
                        <p className="text-corporate-grey-600 mb-2">
                          {office.role}
                        </p>
                        <p className="text-corporate-grey-500 text-sm mb-3">
                          {office.address}
                        </p>
                        <p className="text-corporate-blue-600 font-medium mb-2">
                          {office.phone}
                        </p>
                        <p className="text-xs text-corporate-grey-500">
                          {office.timezone}
                        </p>
                      </div>
