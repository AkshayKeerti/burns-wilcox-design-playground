      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-20">
          <div className="inline-flex items-center gap-3 bg-corporate-blue-100 text-corporate-blue-700 px-4 py-2 rounded-full mb-6">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M6 6V5a3 3 0 013-3h2a3 3 0 013 3v1h2a2 2 0 012 2v3.57A22.952 22.952 0 0110 13a22.95 22.95 0 01-8-1.43V8a2 2 0 012-2h2zm2-1a1 1 0 011-1h2a1 1 0 011 1v1H8V5zm1 3a1 1 0 000 2h.01a1 1 0 100-2H9zm3 0a1 1 0 000 2h.01a1 1 0 100-2H12z" clipRule="evenodd" />
            </svg>
          ...
          <p className="text-xl text-corporate-grey-600 max-w-3xl mx-auto leading-relaxed">
            Join a team of 2,300+ insurance professionals across the globe. Discover opportunities for growth, innovation, and meaningful impact in the insurance industry.
          </p>
        </div>
          ...
          <div className="relative">
            ...
            <div className="space-y-12">
              {careerPaths.map((path, index) => (
                <div key={path.id} className={`relative flex flex-col lg:flex-row items-center gap-8 ${
                  ...
                  <div className={`flex-1 ${index % 2 === 0 ? 'lg:pr-8' : 'lg:pl-8'}`}>
                    ...
                    >
                      <div className="flex items-center gap-4 mb-4">
                        <span className={`bg-gradient-to-r ${path.color} text-white px-3 py-1 rounded-full text-sm font-medium`}>
                          {path.level}
                        </span>
                      ...
                      <div className="mb-4">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {path.skills.map((skill) => (
                            <span key={skill} className="bg-corporate-blue-50 text-corporate-blue-700 text-xs px-2 py-1 rounded-full">
                              {skill}
                            </span>
                          ))}
                        </div>
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {benefits.map((benefit) => (
              <div key={benefit.title} className="bg-white rounded-xl p-6 text-center shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <div className="text-4xl mb-4">{benefit.icon}</div>
                <h3 className="text-xl font-bold text-corporate-grey-900 mb-2">
                  {benefit.title}
                </h3>
        ...
        <div className="bg-corporate-blue-500 rounded-3xl p-12 text-center text-white">
          ...
          <p className="text-xl opacity-90 mb-8 max-w-2xl mx-auto">
            Explore our current openings and find the perfect role to advance your career in the insurance industry.
          </p>
