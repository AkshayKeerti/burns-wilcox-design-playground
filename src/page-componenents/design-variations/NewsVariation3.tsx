          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="font-medium text-corporate-grey-900">
                    {featuredNews[0].author}
                  </div>
            ...
            {featuredNews.slice(1).map((article, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-corporate-grey-600 mb-4 leading-relaxed">{article.excerpt}</p>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="text-sm text-corporate-grey-500">By {article.author}</div>
