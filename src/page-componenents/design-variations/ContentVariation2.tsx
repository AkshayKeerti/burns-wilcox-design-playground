...
export default function ContentVariation2() {
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <div className="bg-corporate-grey-900 text-white">
        <div className="container mx-auto px-4 py-20">
          <div className="max-w-4xl mx-auto">
            <div className="inline-flex items-center px-4 py-2 bg-corporate-blue-500 text-white rounded-full text-sm font-light mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="bg-corporate-blue-500 text-white px-8 py-3 rounded-lg font-light hover:bg-corporate-blue-600 transition-colors flex items-center justify-center">
                Get Cyber Protection
                <ArrowRight className="ml-2 w-4 h-4" />
              </button>
              <button className="border-2 border-white text-white px-8 py-3 rounded-lg font-light hover:bg-white hover:text-corporate-grey-900 transition-colors">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-6 mb-8">
              <div className="bg-white p-6 rounded-lg border border-corporate-grey-200 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              <div className="bg-corporate-grey-50 p-6 rounded-lg border border-corporate-grey-300">
                <h4 className="font-light text-corporate-grey-900 mb-3">Healthcare</h4>
                <p className="text-corporate-grey-700 text-sm font-light">
                  HIPAA compliance, patient data protection, medical device security, and regulatory penalties 
                  for healthcare data breaches.
                </p>
              </div>
              <div className="bg-corporate-grey-50 p-6 rounded-lg border border-corporate-grey-300">
                <h4 className="font-light text-corporate-grey-900 mb-3">Financial Services</h4>
                <p className="text-corporate-grey-700 text-sm font-light">
              ...
              <div className="bg-corporate-grey-50 p-6 rounded-lg border border-corporate-grey-300">
                <h4 className="font-light text-corporate-grey-900 mb-3">Retail & E-commerce</h4>
                <p className="text-corporate-grey-700 text-sm font-light">
              ...
              <div className="bg-corporate-grey-50 p-6 rounded-lg border border-corporate-grey-300">
                <h4 className="font-light text-corporate-grey-900 mb-3">Manufacturing</h4>
                <p className="text-corporate-grey-700 text-sm font-light">
          ...
          <div className="lg:col-span-1">
            {/* Contact Card */}
            <div className="bg-corporate-grey-900 text-white p-6 rounded-lg mb-8">
              ...
              <button className="w-full bg-corporate-blue-500 text-white py-3 px-4 rounded-lg font-light hover:bg-corporate-blue-600 transition-colors mb-4">
                Request Cyber Quote
              </button>
            ...
            <div className="bg-white border border-corporate-grey-200 p-6 rounded-lg mb-8 shadow-sm">
              ...
              <div className="space-y-4">
                <div className="text-center p-4 bg-corporate-grey-50 rounded-lg border border-corporate-grey-300">
                  <div className="text-2xl font-light text-corporate-blue-500">43%</div>
                  <div className="text-corporate-grey-700 text-sm font-light">of cyber attacks target small businesses</div>
                </div>
                <div className="text-center p-4 bg-corporate-grey-50 rounded-lg border border-corporate-grey-300">
                  <div className="text-2xl font-light text-corporate-blue-500">$4.45M</div>
                  <div className="text-corporate-grey-700 text-sm font-light">average cost of a data breach</div>
                </div>
                <div className="text-center p-4 bg-corporate-grey-50 rounded-lg border border-corporate-grey-300">
                  <div className="text-2xl font-light text-corporate-blue-500">287 days</div>
                  <div className="text-corporate-grey-700 text-sm font-light">average time to identify a breach</div>
                </div>
              </div>
            </div>

            {/* Testimonial */}
            <div className="bg-corporate-blue-500 text-white p-6 rounded-lg mb-8">
              ...
              <div className="flex items-center">
                <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center mr-3">
                  <span className="font-light text-corporate-blue-500">MS</span>
                </div>
                <div>
            ...
            <div className="bg-white border border-corporate-grey-200 p-6 rounded-lg shadow-sm">
              ...
              <div className="space-y-3">
                <Link href="#" className="flex items-center text-corporate-blue-500 hover:text-corporate-blue-600 font-light">
      ...
      {/* CTA Section */}
      <div className="bg-corporate-grey-900 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <button className="bg-corporate-blue-500 text-white px-8 py-3 rounded-lg font-light hover:bg-corporate-blue-600 transition-colors">
              Get Cyber Protection
            </button>
            <Link href="/solutions" className="border-2 border-white text-white px-8 py-3 rounded-lg font-light hover:bg-white hover:text-corporate-grey-900 transition-colors">
              View All Solutions
            </Link>
          </div>
        </div>
