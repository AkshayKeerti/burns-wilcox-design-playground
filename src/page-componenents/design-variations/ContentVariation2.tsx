          ...
          <div className="lg:col-span-1">
            ...
            <div className="bg-white border border-corporate-grey-200 p-6 rounded-lg mb-8 shadow-sm">
              ...
              <div className="space-y-4">
                <div className="text-center p-4 bg-corporate-grey-50 rounded-lg border border-corporate-grey-300">
                  ...
                  <div className="text-corporate-grey-700 text-sm font-light">
            ...
            <div className="bg-white border border-corporate-grey-200 p-6 rounded-lg shadow-sm">
              ...
              <div className="space-y-3">
                <Link
                  href="#"
                  className="flex items-center text-corporate-blue-500 hover:text-corporate-blue-600 font-light"
                >
      ...
      <div className="bg-corporate-grey-900 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <Link
              href="/solutions"
              className="border-2 border-white text-white px-8 py-3 rounded-lg font-light hover:bg-white hover:text-corporate-grey-900 transition-colors"
            >
              View All Solutions
            </Link>
          </div>
