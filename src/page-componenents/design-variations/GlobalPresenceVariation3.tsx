        ...
        <div className="relative z-10 text-center text-white max-w-5xl mx-auto px-8">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 max-w-2xl mx-auto">
            ...
            <div className="flex items-center justify-center gap-6 text-sm">
              <span className="text-corporate-blue-200">{regions[activeRegion].offices} Offices</span>
              <span className="text-white/60">•</span>
              <span className="text-corporate-blue-200">
                {regions[activeRegion].coordinates.lat.toFixed(2)}°N, {regions[activeRegion].coordinates.lng.toFixed(2)}°E
              </span>
            </div>
          </div>
        </div>
