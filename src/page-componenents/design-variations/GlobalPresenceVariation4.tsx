            ...
            {regions.map((region, index) => (
              ...
              >
                <div className="relative h-96 overflow-hidden">
                  ...
                  {/* Bold Floating Stats */}
                  <div
                    className={`absolute top-6 right-6 ${region.color} text-white px-4 py-2 rounded-full text-lg font-black shadow-2xl`}
                  >
                    {region.offices}
                  </div>
                ...
                <div className="p-8 bg-white">
                  ...
                  <button
                    className={`w-full ${region.color} text-white py-4 px-6 rounded-xl font-black text-lg hover:shadow-2xl transition-all duration-500 group-hover:scale-105`}
                  >
                    Explore {region.name}
                  </button>
                </div>
