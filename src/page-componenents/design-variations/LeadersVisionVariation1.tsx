            ...
            {coreValues.map((value, index) => (
              ...
              >
                <div className="flex items-start gap-6">
                  <div
                    className={`text-4xl bg-gradient-to-r ${value.color} bg-clip-text text-transparent`}
                  >
                    {value.icon}
                  </div>
              ...
              >
                <div className="p-8">
                  <div className="flex items-start gap-6 mb-4">
                    <div
                      className={`text-4xl bg-gradient-to-r ${goal.color} bg-clip-text text-transparent`}
                    >
                      {goal.icon}
                    </div>
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        <span
                          className={`inline-block bg-gradient-to-r ${goal.color} text-white px-3 py-1 rounded-full text-sm font-bold`}
                        >
                          {goal.year}
                        </span>
                        <h3 className="text-2xl font-bold text-corporate-grey-900">{goal.title}</h3>
                      </div>
                      <p className="text-corporate-grey-600 leading-relaxed">{goal.description}</p>
                    </div>
                  </div>
                </div>
              </div>
