    ...
    <section className="bg-white w-full">
                    ...
                    <div className="mb-6">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {path.skills.map(skill => (
                          <span
                            key={skill}
                            className="text-sm text-corporate-blue-600 border border-corporate-blue-200 px-3 py-1"
                          >
                            {skill}
                          </span>
                        ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {benefits.map(benefit => (
              <div key={benefit.title} className="text-center group">
                ...
                <h3 className="text-xl font-light text-corporate-grey-900 mb-3">{benefit.title}</h3>
                <p className="text-corporate-grey-600 leading-relaxed">{benefit.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="py-24 px-8 bg-corporate-blue-900">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-light text-white mb-6">Ready to Start Your Journey?</h2>
