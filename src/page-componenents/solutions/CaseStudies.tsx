...
export default function CaseStudies() {
  const cases = [
    {
      title: 'Global Retailer Cyber Resilience',
      img: '/hero.webp',
      summary: 'Deployed layered cyber program reducing exposure by 45%.',
    },
    {
      title: 'Port Operator Marine Program',
      img: '/hero-1.jpg',
      summary: 'Comprehensive marine package across cargo and hull.',
    },
    {
      title: 'Healthcare Network Liability',
      img: '/hero-3.jpg',
      summary: 'Claims-made structure optimizing limits and premium.',
    },
  ];
  return (
